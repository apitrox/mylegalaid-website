...
const translations = {
  ...
  vi: {
    ...
    'nav-how': 'Cách thức hoạt động',
    'nav-testimonials': 'Đánh giá',
    'nav-faq': 'Câu hỏi thường gặp',
    'cta-header': 'Tư vấn miễn phí',
    'hero-eyebrow': 'Hỗ trợ pháp lý giá cả phải chăng, đơn giản hóa',
    'hero-title': 'Hỗ trợ pháp lý chuyên nghiệp không phức tạp hay phí bất ngờ.',
    'hero-lead': 'Kết nối với các chuyên gia pháp lý đã được xác minh cho hợp đồng, di trú, vấn đề gia đình, tranh chấp và hơn thế nữa. Các bước rõ ràng. Giá cả minh bạch. Phản hồi nhanh chóng.',
    'cta-book': 'Đặt lịch tư vấn miễn phí',
    'cta-explore': 'Khám phá dịch vụ',
    'popular-requests': 'Yêu cầu phổ biến',
    'stat-doc': 'Xem xét tài liệu',
    'stat-satisfaction': 'Sự hài lòng của khách hàng',
    'stat-cases': 'Các trường hợp được hỗ trợ',
    'badge-pricing': 'Giá cố định, minh bạch',
    'badge-secure': 'An toàn & bảo mật',
    'badge-vetted': 'Chuyên gia đã xác minh',
    'badge-fast': 'Thời gian phản hồi nhanh',
    'services-title': 'Dịch vụ pháp lý dễ tiếp cận',
    'services-kicker': 'Chọn những gì bạn cần - không có thuật ngữ, không có bất ngờ.',
    'service1-title': 'Hợp đồng & Kinh doanh',
    'service1-desc': 'Soạn thảo, xem xét và hướng dẫn cho các thỏa thuận, NDA, điều khoản đối tác và hơn thế nữa.',
    'service1-price': 'Từ $149',
    'service2-title': 'Nhập cư',
    'service2-desc': 'Đơn xin visa, kháng cáo, giấy phép bảo lãnh và chuẩn bị tài liệu.',
    'service2-price': 'Từ $199',
    'service3-title': 'Gia đình & Cá nhân',
    'service3-desc': 'Ly hôn, quyền nuôi con, di chúc, thay đổi tên và các vấn đề nhạy cảm với sự quan tâm.',
    'service3-price': 'Từ $179',
    'service4-title': 'Nhà ở & Tranh chấp',
    'service4-desc': 'Các vấn đề giữa chủ nhà và người thuê, khiếu nại nhỏ, thu hồi nợ và đàm phán.',
    'service4-price': 'Từ $129',
    'service5-title': 'Việc làm',
    'service5-desc': 'Hợp đồng, khiếu nại, thỏa thuận giải quyết và quyền lợi tại nơi làm việc.',
    'service5-price': 'Từ $159',
    'service6-title': 'Xem xét tài liệu',
    'service6-desc': 'Xem xét nhanh các tài liệu pháp lý với ghi chú rõ ràng và có thể hành động.',
    'service6-price': 'Từ $89',
    'how-title': 'Cách thức hoạt động',
    'how-kicker': 'Ba bước rõ ràng - hoàn thành trong vài ngày, không phải vài tuần.',
    'step1-title': 'Cho chúng tôi biết bạn cần gì',
    'step1-desc': 'Chia sẻ bản tóm tắt ngắn hoặc tải lên tài liệu. Chúng tôi kết nối bạn với chuyên gia phù hợp.',
    'step2-title': 'Nhận báo giá cố định',
    'step2-desc': 'Phạm vi rõ ràng, thời gian và giá cả - không có bất ngờ theo giờ.',
    'step3-title': 'Làm việc và giải quyết',
    'step3-desc': 'Nhắn tin an toàn, theo dõi tiến độ và nhận kết quả bạn có thể tin cậy.',
    'testimonials-title': 'Khách hàng nói gì',
    'testimonials-kicker': 'Kết quả thực tế từ những người và doanh nghiệp thực tế.',
    'testimonial1': '"Giá cả rõ ràng và giao hàng nhanh. Đã tiết kiệm cho startup của chúng tôi vài tuần."',
    'testimonial1-author': '— Priya, Người sáng lập',
    'testimonial2': '"Họ giải thích mọi thứ mà không có thuật ngữ. Cảm thấy được hỗ trợ trong suốt quá trình."',
    'testimonial2-author': '— Ahmed, Người cha',
    'testimonial3': '"Xem xét tài liệu vào cùng ngày và rất hữu ích."',
    'testimonial3-author': '— James, Nhà thầu',
    'faq-title': 'Câu hỏi thường gặp',
    'faq1-q': 'Bạn có thể bắt đầu nhanh như thế nào?',
    'faq1-a': 'Đối với hầu hết các vấn đề, trong vòng 24-48 giờ sau cuộc gọi và báo giá ban đầu.',
    'faq2-q': 'Bạn có cung cấp giá cố định không?',
    'faq2-a': 'Có. Chúng tôi xác định phạm vi công việc và cung cấp mức phí cố định trước khi bạn tiến hành.',
    'faq3-q': 'Thông tin của tôi có an toàn không?',
    'faq3-a': 'Hoàn toàn. Dữ liệu của bạn được mã hóa trong quá trình truyền và được xử lý một cách bảo mật.',
    'contact-title': 'Nhận tư vấn miễn phí của bạn',
    'contact-kicker': 'Cho chúng tôi biết một chút về vấn đề của bạn. Chúng tôi sẽ liên hệ lại trong vòng 24 giờ.',
    'form-name': 'Tên',
    'form-name-placeholder': 'Nguyễn Văn A',
    'form-email': 'Email',
    'form-email-placeholder': 'nguyen@email.com',
    'form-message': 'Mô tả ngắn gọn',
    'form-message-placeholder': 'Cho chúng tôi biết về nhu cầu pháp lý của bạn...',
    'form-submit': 'Yêu cầu tư vấn'
  }
};
